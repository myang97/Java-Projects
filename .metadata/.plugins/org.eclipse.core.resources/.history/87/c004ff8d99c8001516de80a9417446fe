...
//This class simulates the Texas Lottery Game. 
//It obtains the winning lottery numbers, and then starts a timer trying to see how long it'll take before the 6 numbers match up
//Outputs the amount of times and time it takes before the correct numbers are found
public class TexasLottoGame{
	public static void main (String[]args){
		...
		int ctr = 0;
		int tex1 = 0, tex2 = 0, tex3 = 0, tex4 = 0, tex5 = 0, tex6 = 0;
		int my1 = 0, my2 = 0, my3 = 0, my4 = 0, my5 = 0, my6 = 0;
